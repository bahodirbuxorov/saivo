          ...
          >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {featuredArticles.slice(0, 3).map((article, index) => (
                <motion.div
                  key={article.id}
                  className="group glass rounded-2xl overflow-hidden hover:shadow-xl transition-all duration-300 cursor-pointer"
        ...
        {searchLoading && (
          <div className="flex justify-center items-center py-12">
            <div className="text-center">
              ...
              <span className="text-muted-foreground">Filtering articles...</span>
            </div>
          </div>
        )}
